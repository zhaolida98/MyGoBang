...
class AI(object):
    ...
    def makeScore(self, count, barrier, gap):
        ...
        #空隙在第一个位置或者倒数第一个0_0000
            ...
            if barrier == 0:
                ...
                if count >= 4: return score['DEAD_JUMP_FOUR']
                elif count == 3: return score['DEAD_JUMP_THREE']
                elif count == 2: return score['DEAD_JUMP_TWO']
            else:
                return 0
    ...
    def is_win(self, x, y, chessboard, role):
        ...
        if count == 5:
            return True
        elif count == 4 and barrier == 0:
            return True
        elif count == 4 and barrier == 1:
            rush_four = rush_four + 1
        elif count == 3 and barrier == 0:
            live_three = live_three + 1
        else:
            pass
        ...
        if count == 5:
            ...
            pass
        if rush_four >=1 and live_three >= 1:
            return True
        elif rush_four >= 2:
            return True
        return False
